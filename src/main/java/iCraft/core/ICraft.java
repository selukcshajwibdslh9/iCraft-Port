...
import iCraft.core.tile.TileEntityPackingCase; // Добавил этот импорт
...
import net.minecraftforge.fml.common.registry.GameRegistry; // Добавил этот импорт
...
public class ICraft {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        // РЕГИСТРАЦИЯ ТУТ:
        GameRegistry.registerTileEntity(TileEntityPackingCase.class, "packing_case_te");
    ...
    public void init(FMLInitializationEvent event) {
        proxy.init(event);
        ICraftUtils.loadTradeOffers(); // ДОБАВЬ ЭТУ СТРОКУ
